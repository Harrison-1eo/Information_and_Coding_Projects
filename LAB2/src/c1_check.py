import hashlib
import random
from HammingMatrix import hamming_matrix

hamming = hamming_matrix(15, 11)
...
with open('./test/hamming_c1.txt', 'wb') as f:
...
with open('./test/hamming_c1.txt', 'rb') as f:
    hash2 = hashlib.md5(f.read()).hexdigest()
    print('./test/hamming_c1.txt hash: ', hash2)
